...
public class EnrollmentDialogFragment extends DialogFragment {
	...
	public interface EnrollmentDialogListener {
		void onEnrollmentIDProvided(String id,String nid, String imei, String country);
	}
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		nid = (EditText) view.findViewById(R.id.nid);
		geoLocation = view.findViewById(R.id.country_name);
		imeiNo = view.findViewById(R.id.imei_no);

		imeiNo.setText(Utils.imeiNo);
		geoLocation.setText(Utils.countryName);
		...
		builder.setPositiveButton(getString(R.string.msg_enroll), new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int id) {
				mListener.onEnrollmentIDProvided(mEditText.getText().toString().trim(),nid.getText().toString().trim(),imeiNo.getText().toString().trim(),geoLocation.getText().toString().trim());
			}
		});
